    ...
    <form action="" id="frm" method="post" enctype="multipart/form-data">
        <div class="container">
            ...
            <div class="rowBox">
                ...
                <div class="contents">
                    <input type="text" name="store_name" placeholder="상호명입력" id="store_name" class="input form-control" maxlength="20">
                </div>
            </div>
            <div class="rowBox">
                ...
                <span class="phone_msg" style="font-size: 7px; width: 40%; line-height: 40px; padding-left:10px"></span>

            </div>
            <div class="rowBox">
                <div class="title">우편번호</div>
                <div class="contents input-group"><input style="height: 40px" type="text" id="postcode" placeholder="우편번호" class="input form-control" readonly>
            ...
            <div class="rowBox">
                ...
                <div class="contents"><input type="text" id="add1" name="store_add_detail1" placeholder="기본주소"
                                             id="store_add_detail1" class="input  form-control" readonly></div>
            </div>
            <div class="rowBox">
                <div class="title">상세주소</div>
                <div class="contents"><input type="text" id="add2" name="store_add_detail2" placeholder="상세주소"
                                             id="store_add_detail2" class="input form-control" maxlength="30"></div>
            </div>
            ...
            <div class="rowBox">
                ...
                <div class="contents" style="display: inline; width: 300px" > <input type="text" name="store_close_day" placeholder="휴무일" class="input close_day form-control"  maxlength="30"> </div>
            ...
            <div class="rowBox">
                ...
                <div class="contents"> <input type="text" name="store_destination" id="store_destination"
                                              placeholder="배달 가능 지역" class="input form-control" maxlength="30"></div>
            </div>
